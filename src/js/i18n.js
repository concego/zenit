...
const P = {
    "pt-BR": {
        ...
        materials: { ratFur: "pele de rato", diseaseGland: "glândula de doença", wolfPelt: "pele de lobo", wolfFang: "presa de lobo", sinew: "tendão", boarHide: "couro de javali", boarTusk: "presa de javali", rawMeat: "carne crua", spiderSilk: "seda de aranha", venomGland: "glândula de veneno", slimeCore: "núcleo de slime", acidGland: "glândula ácida", scrapMetal: "sucata metálica", clothScrap: "retalho de tecido", feather: "pena", talon: "garra", stoneCore: "núcleo de pedra", ironFragment: "fragmento de ferro", scale: "escama", dragonBlood: "sangue de dragão", bone: "osso", oldMetal: "metal antigo", darkCloth: "tecido sombrio", ritualInk: "tinta ritual", ectoplasm: "ectoplasma", shadowShard: "fragmento de sombra" },
        enemies: { species: { rat: "Rato", slime: "Slime", cultist: "Cultista", wolf: "Lobo", boar: "Javali", spider: "Aranha", bandit: "Bandido", harpy: "Harpia", golem: "Golem", dragonkin: "Draconídeo", skeleton: "Esqueleto", shade: "Sombra" }, bosses: { rat: "Matriarca dos Ratos", slime: "Colosso de Lodo", cultist: "Hierofante do Esgoto", wolf: "Alfa da Matilha", boar: "Javali Ancião", spider: "Aranha-Mãe", bandit: "Chefe dos Bandidos", harpy: "Rainha das Harpias", golem: "Colosso de Pedra", dragonkin: "Dragão Ancestral", skeleton: "Senhor dos Ossos", shade: "Sombra Abissal" } },
        skills: { names: { guardian_oath: "Juramento do Guardião", aimed_shot: "Disparo Preciso", arcane_spark: "Faísca Arcana", heavy_strike: "Golpe Pesado", shield_bastion: "Bastião do Escudo", battle_prayer: "Oração de Batalha", rally: "Comando de Reunião", precise_shot: "Tiro Preciso", shadow_step: "Passo Sombrio", trap: "Armadilha", beast_companion: "Companheiro Animal", elemental_bolt: "Projétil Elemental", healing_rite: "Rito de Cura", spirit_call: "Chamado Espiritual", root_entangle: "Raízes Enredantes", second_wind: "Segundo Fôlego", smoke_screen: "Cortina de Fumaça", ward: "Proteção Arcana", poisoned_edge: "Lâmina Envenenada", blood_pact: "Pacto de Sangue" }, descriptions: { guardian_oath: "Fortalece a defesa e reduz parte do dano recebido.", aimed_shot: "Concentra o disparo para causar mais dano e melhorar a precisão.", arcane_spark: "Dispara uma faísca mágica contra um alvo a até 3 casas de distância.", heavy_strike: "Desfere um golpe poderoso que pode desequilibrar o alvo.", shield_bastion: "Usa o escudo para aumentar a defesa e bloquear ataques.", battle_prayer: "Uma oração que causa dano e restaura parte da vida.", rally: "Aumenta Potência e Coordenação por um período.", precise_shot: "Um disparo focado com chance maior de acerto crítico.", shadow_step: "Permite um deslocamento rápido e aumenta a evasão.", trap: "Prepara uma armadilha que causa dano e controla o inimigo.", beast_companion: "Invoca um companheiro que luta ao seu lado.", elemental_bolt: "Lança um projétil elemental a até 4 casas de distância.", healing_rite: "Canaliza energia para restaurar a vida.", spirit_call: "Invoca um espírito que causa dano e oferece resistência.", root_entangle: "Prende inimigos com raízes e causa dano.", second_wind: "Recupera vida e estamina em um momento de necessidade.", smoke_screen: "Cria fumaça, aumentando a evasão e dificultando ações inimigas.", ward: "Cria uma proteção que aumenta armadura e resistência.", poisoned_edge: "Aplica veneno ao próximo ataque.", blood_pact: "Sacrifica vida para desferir um ataque muito poderoso." } },
        gameplay: { map: "Mapa", level: "nível", mainMenu: "Menu principal", status: "Status", inventory: "Inventário", equipment: "Equipamento", skills: "Habilidades", class: "Classe", power: "Potência", coordination: "Coordenação", mind: "Mente", hp: "HP", stamina: "Estamina", mana: "Mana", gold: "Ouro", empty: "Vazio", box: "Caixa", range: "alcance", head: "Cabeça", neck: "Pescoço", ring1: "Anel 1", ring2: "Anel 2", torso: "Tronco", body: "Sobre o Corpo", waist: "Cintura", legs: "Pernas", feet: "Pés", melee: "Arma Corpo a Corpo", ranged: "Arma à Distância", shield: "Escudo", direction: { CIMA: "cima", BAIXO: "baixo", ESQUERDA: "esquerda", DIREITA: "direita" }, item: { "Vanguarda / Campeão": "Vanguarda / Campeão", "Caçador / Patrulheiro": "Caçador / Patrulheiro", "Místico / Erudito": "Místico / Erudito", "Espada Curta": "Espada Curta", "Arco Curto": "Arco Curto" }, messages: { boundary: "Fronteira do mapa alcançada.", doorAhead: " Porta à frente. Pressione Enter para abrir.", boxAhead: " A caixa deve ser destruída ou contornada.", waterAhead: " A água impede a passagem.", objectAhead: " Um objeto bloqueia a passagem.", enemyAhead: " Inimigo à frente. Ataque para abrir caminho.", blocked: "Caminho bloqueado para", scanWall: "parede em", scanWater: "água em", scanEnemy: "inimigo em", scanBoss: "boss em", scanBox: "caixa em", scanObject: "objeto em", scanDoor: "porta em", scanNone: "nenhum obstáculo ou porta relevante no campo de visão", scanDone: "Varredura em cone concluída", noWeapon: "Nenhuma arma equipada nesta instância.", attackWall: "Ataque bloqueado por parede em", attackDoor: "A porta bloqueia o ataque. Pressione Enter para interagir com ela.", destroyed: "destruída. Você encontrou", total: "Total", attackDone: "Ataque desferido com", noTarget: "Nenhum alvo ao alcance.", nothing: "Nada com que interagir nesta direção.", doorOpened: "Porta aberta. Você avançou para o nível", activeWeapon: "Arma ativa", none: "nenhuma", looking: "Você está olhando para", look: "Olhar direcionado para", menuHint: "Use as setas, Enter para selecionar e Escape para fechar.", submenuStatus: "Submenu de Status.", submenuEquipment: "Submenu de Equipamento.", submenuSkills: "Submenu de Habilidades.", inventoryEmpty: "Inventário vazio.", option: "Opção", skillDescription: "Descrição", skillLevel: "Nível", skillLevelShort: "nível", skillCost: "Custo", skillUseCost: "Custo de uso", skillRange: "Alcance em casas", skillPoints: "Pontos de habilidade disponíveis", skillRequirements: "Requisitos", skillNone: "nenhum", skillReady: "Pronto para aprender. Pressione Enter para comprar.", skillNeedPoints: "Pontos insuficientes.", skillNeedRequirements: "Requisitos ainda não atendidos.", skillMax: "Nível máximo alcançado.", skillPurchased: "habilidade aprimorada para o nível" , skillCannotPurchase: "A habilidade não foi comprada.", skillShortcut: "Atalho numérico", skillAssigned: "atribuída ao atalho", skillMustBeLearned: "Aprenda a habilidade antes de atribuí-la a um atalho.", skillSlot: "Atalho", skillUnassigned: "nenhuma habilidade atribuída.", skillUnavailable: "Habilidade indisponível.", skillCannotUse: "A habilidade não pode ser usada agora.", skillNoResource: "Recurso insuficiente", skillHeal: "Vida recuperada", skillStamina: "Estamina recuperada", skillNextAttack: "Efeito preparado para o próximo ataque", skillEffectActive: "Efeito defensivo ativo", skillCompanion: "Companheiro invocado", skillAttackBonus: "Bônus de dano", skillUsed: "usada", attackMissed: "Você errou o ataque contra", damageDealt: "Dano causado", enemyRemaining: "vida restante", enemyDefeated: "Inimigo derrotado:", bossDefeated: "Boss derrotado:", enemyLoot: "Loot obtido", containerLoot: "Loot do recipiente", enemyItem: "Item", enemyMoves: "se moveu", enemyMisses: "errou o ataque", enemyHits: "atingiu você causando", playerHp: "HP restante", playerDefeated: "Você foi derrotado. O personagem foi perdido." } }
    },
    en: {
        ...
        materials: { ratFur: "rat fur", diseaseGland: "disease gland", wolfPelt: "wolf pelt", wolfFang: "wolf fang", sinew: "sinew", boarHide: "boar hide", boarTusk: "boar tusk", rawMeat: "raw meat", spiderSilk: "spider silk", venomGland: "venom gland", slimeCore: "slime core", acidGland: "acid gland", scrapMetal: "scrap metal", clothScrap: "cloth scrap", feather: "feather", talon: "talon", stoneCore: "stone core", ironFragment: "iron fragment", scale: "scale", dragonBlood: "dragon blood", bone: "bone", oldMetal: "old metal", darkCloth: "dark cloth", ritualInk: "ritual ink", ectoplasm: "ectoplasm", shadowShard: "shadow shard" },
        enemies: { species: { rat: "Rat", slime: "Slime", cultist: "Cultist", wolf: "Wolf", boar: "Boar", spider: "Spider", bandit: "Bandit", harpy: "Harpy", golem: "Golem", dragonkin: "Dragonkin", skeleton: "Skeleton", shade: "Shade" }, bosses: { rat: "Rat Matriarch", slime: "Sludge Colossus", cultist: "Sewer Hierophant", wolf: "Pack Alpha", boar: "Elder Boar", spider: "Mother Spider", bandit: "Bandit Chief", harpy: "Harpy Queen", golem: "Stone Colossus", dragonkin: "Ancient Dragonkin", skeleton: "Bone Lord", shade: "Abyssal Shade" } },
        skills: { names: { guardian_oath: "Guardian's Oath", aimed_shot: "Aimed Shot", arcane_spark: "Arcane Spark", heavy_strike: "Heavy Strike", shield_bastion: "Shield Bastion", battle_prayer: "Battle Prayer", rally: "Rally", precise_shot: "Precise Shot", shadow_step: "Shadow Step", trap: "Trap", beast_companion: "Beast Companion", elemental_bolt: "Elemental Bolt", healing_rite: "Healing Rite", spirit_call: "Spirit Call", root_entangle: "Entangling Roots", second_wind: "Second Wind", smoke_screen: "Smoke Screen", ward: "Arcane Ward", poisoned_edge: "Poisoned Edge", blood_pact: "Blood Pact" }, descriptions: { guardian_oath: "Strengthens defense and reduces part of incoming damage.", aimed_shot: "Focuses a shot to deal more damage and improve accuracy.", arcane_spark: "Fires a magical spark at a target up to 3 tiles away.", heavy_strike: "Delivers a powerful strike that may stagger the target.", shield_bastion: "Uses a shield to increase defense and block attacks.", battle_prayer: "A prayer that deals damage and restores some health.", rally: "Increases Power and Coordination for a period.", precise_shot: "A focused shot with a higher critical hit chance.", shadow_step: "Allows a quick movement and increases evasion.", trap: "Prepares a trap that damages and controls an enemy.", beast_companion: "Summons a companion that fights beside you.", elemental_bolt: "Launches an elemental projectile up to 4 tiles away.", healing_rite: "Channels energy to restore health.", spirit_call: "Summons a spirit that deals damage and grants resistance.", root_entangle: "Binds enemies with roots and deals damage.", second_wind: "Recovers health and stamina in a moment of need.", smoke_screen: "Creates smoke, increasing evasion and hindering enemy actions.", ward: "Creates protection that increases armor and resistance.", poisoned_edge: "Applies poison to the next attack.", blood_pact: "Sacrifices health to deliver a very powerful attack." } },
        gameplay: { map: "Map", level: "level", mainMenu: "Main menu", status: "Status", inventory: "Inventory", equipment: "Equipment", skills: "Skills", class: "Class", power: "Power", coordination: "Coordination", mind: "Mind", hp: "HP", stamina: "Stamina", mana: "Mana", gold: "Gold", empty: "Empty", box: "Box", range: "range", head: "Head", neck: "Neck", ring1: "Ring 1", ring2: "Ring 2", torso: "Torso", body: "Over the Body", waist: "Waist", legs: "Legs", feet: "Feet", melee: "Melee Weapon", ranged: "Ranged Weapon", shield: "Shield", direction: { CIMA: "up", BAIXO: "down", ESQUERDA: "left", DIREITA: "right" }, item: { "Vanguarda / Campeão": "Vanguard / Champion", "Caçador / Patrulheiro": "Hunter / Ranger", "Místico / Erudito": "Mystic / Scholar", "Espada Curta": "Short Sword", "Arco Curto": "Short Bow" }, messages: { boundary: "Map boundary reached.", doorAhead: " Door ahead. Press Enter to open.", boxAhead: " The box must be destroyed or avoided.", waterAhead: " Water blocks the path.", objectAhead: " An object blocks the path.", enemyAhead: " Enemy ahead. Attack to clear the path.", blocked: "Path blocked to", scanWall: "wall at", scanWater: "water at", scanEnemy: "enemy at", scanBoss: "boss at", scanBox: "box at", scanObject: "object at", scanDoor: "door at", scanNone: "no relevant obstacle or door in view", scanDone: "Cone scan complete", noWeapon: "No weapon is equipped in this instance.", attackWall: "Attack blocked by wall at", attackDoor: "The door blocks the attack. Press Enter to interact with it.", destroyed: "destroyed. You found", total: "Total", attackDone: "Attack performed with", noTarget: "No target in range.", nothing: "Nothing to interact with in this direction.", doorOpened: "Door opened. You advanced to", activeWeapon: "Active weapon", none: "none", looking: "You are looking", look: "Looking toward", menuHint: "Use the arrows, Enter to select, and Escape to close.", submenuStatus: "Status submenu.", submenuEquipment: "Equipment submenu.", submenuSkills: "Skills submenu.", inventoryEmpty: "Inventory is empty.", option: "Option", skillDescription: "Description", skillLevel: "Level", skillLevelShort: "level", skillCost: "Learning cost", skillUseCost: "Use cost", skillRange: "Range in tiles", skillPoints: "Available skill points", skillRequirements: "Requirements", skillNone: "none", skillReady: "Ready to learn. Press Enter to buy.", skillNeedPoints: "Not enough skill points.", skillNeedRequirements: "Requirements are not met yet.", skillMax: "Maximum level reached.", skillPurchased: "skill upgraded to level", skillCannotPurchase: "The skill was not purchased.", skillShortcut: "Number shortcut", skillAssigned: "assigned to shortcut", skillMustBeLearned: "Learn the skill before assigning it to a shortcut.", skillSlot: "Shortcut", skillUnassigned: "no skill assigned.", skillUnavailable: "Skill unavailable.", skillCannotUse: "The skill cannot be used now.", skillNoResource: "Insufficient resource", skillHeal: "Health restored", skillStamina: "Stamina restored", skillNextAttack: "Effect prepared for the next attack", skillEffectActive: "Defensive effect active", skillCompanion: "Companion summoned", skillAttackBonus: "Damage bonus", skillUsed: "used", attackMissed: "You missed the attack against", damageDealt: "Damage dealt", enemyRemaining: "remaining health", enemyDefeated: "Enemy defeated:", bossDefeated: "Boss defeated:", enemyLoot: "Loot obtained", containerLoot: "Container loot", enemyItem: "Item", enemyMoves: "moved", enemyMisses: "missed the attack", enemyHits: "hit you for", playerHp: "HP remaining", playerDefeated: "You were defeated. The character was lost." } }
    }
};
